...
This section will install - if needed - necessary packages and load them, as well as downloading data and store it in a new directory.

```{r}
packages <- c("tidyverse", "haven", "rdrobust", "rddensity")
...
# Density plot
#| fig-height: 4 # otherwise unnecessary empty space will appear below the graph
